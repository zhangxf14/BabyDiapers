...
//        mBluetoothAdapter.startLeScan(mDeviceFoundCallback);
    ...
    public void getCharacteristicValue(BluetoothGattCharacteristic ch) {
        ...
        if(uuid.equals(BleDefinedUUIDs.Characteristic.SIMPLEPROFILE_CHAR6)) { // heart rate
...
//        	strValue = intValue + " bpm"; // it is always in bpm units
        	strValue = intValue + " V"; // it is always in V units
        }
        else if (uuid.equals(BleDefinedUUIDs.Characteristic.SIMPLEPROFILE_CHAR6) || // manufacturer name string
